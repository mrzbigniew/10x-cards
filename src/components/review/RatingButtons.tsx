...
const BUTTONS = [
  { rating: 1 as const, label: "Raz jeszcze", style: "border-red-500/40 bg-red-600/20 text-red-300 hover:bg-red-600/30" },
  {
    rating: 2 as const,
    label: "Trudna",
  ...
  { rating: 4 as const, label: "Łatwa", style: "border-blue-500/40 bg-blue-600/20 text-blue-300 hover:bg-blue-600/30" },
];
